...
const handleClickToAdd=(info)=>{
// dispatch(addItem("pizzaaaa"))
dispatch(addItem(info))
  ...
  return (
    <div className='flex  py-10 justify-between items-center border-b border-gray-400 '>
...
:""}
{imageId?<button className='bg-black text-white  md:px-10 md:py-4 px-6 py-2 font-bold md:text-2xl text-xl md:absolute md:top-44 md:left-[4.7rem] rounded-3xl  ' onClick={()=>handleClickToAdd(info)}>Add+</button>
:
<button className='bg-black text-white  md:px-10 md:py-4 px-6 py-2 font-bold md:text-2xl text-xl md:absolute md:top-12 md:-left-56  rounded-3xl  ' onClick={()=>handleClickToAdd(info)}>Add+</button>
